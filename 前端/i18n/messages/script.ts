...
export const script: NamespaceMessages = {
  zh: {
    ...
    fallbackRegenHint: "——点「重新生成」可再试一次 AI",
    scriptHeroDesc: "简单看一下，能用就直接点下一步。",
    scriptResultTitle: "生成结果",
    scriptResultMeta: "{n} 个分镜 · {duration}s",
    ...
    autoFinish: "一键成片",
    autoFinishHint: "自动完成剩余步骤：配画面 → 配音合成 → 直达导出；模型由工作人员维护",
  ...
  en: {
    ...
    autoFinishHint: "Auto-complete the rest: match footage → voiceover and compose → export; models are staff-managed",
