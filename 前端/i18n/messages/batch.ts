...
export const batch: NamespaceMessages = {
  zh: {
    ...
    emptyHint: "生成库存还是空的，导入示例分组即可马上体验批量出片",
  ...
  en: {
    ...
    emptyHint: "Your generated inventory is empty — import sample groups to try batch production right away",
    importExamples: "Import sample products",
    goToProducts: "Go to generated inventory",
    // 步骤 2
