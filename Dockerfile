...
# AI Marketing Center 自托管镜像：Next standalone + 静态 ffmpeg(来自 npm 依赖) + 内置中文字体，数据落 /data 卷。
# 一键自托管：
#   docker run -d -p 3000:3000 -v ai-marketing-center-data:/data ghcr.io/xiaoyuyu7239-design/ai-marketing-center:latest
