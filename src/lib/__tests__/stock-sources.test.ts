...
import {
  ...
  type OpenverseImage,
  type OpenverseAudio,
} from "@backend/providers/openverse";
import {
...
} from "@backend/providers/pixabay";
import {
  resolveSourceKey,
  isSourceAvailable,
  getAvailableSources,
  rankStockCandidates,
} from "@backend/providers/stock-registry";
import { inferExtension, type StockCandidate } from "@backend/providers/stock-types";
import {
  stripHtml,
  ...
  type CommonsPage,
} from "@backend/providers/wikimedia";
import { STOCK_SOURCES } from "@backend/providers/stock-types";
