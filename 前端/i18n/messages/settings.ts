...
export const settings: NamespaceMessages = {
  zh: {
    ...
    presetDoubaoTip: "需填 Ark 推理接入点 ID",
    presetOllamaTip: "本地离线·免费，需先 ollama pull 模型",
    presetPollinationsTip: "免费免 Key，稳定性一般",
    ...
    llmTestError: "连接失败 ✗",
    llmTestButton: "测试连接",
    llmTestTimeout: "连接测试超时：10 秒内没有响应，请稍后重试或检查 Ark 接入点/网络。",
    customModelSuffix: " ·自定义",
    advancedSection: "高级 · 自定义模型接入点 / 生成参数",
    llmFillKeyFirst: "请先填写 API Key",
    connectFailed: "连接失败",
    llmArkEndpointTip:
      "火山方舟：文本模型/视觉模型请填写控制台里的推理接入点 ID（通常以 ep- 开头），不要填模型展示名。",
    llmTestTip:
      "提示：连接测试会在服务端用当前文本模型发起一次轻量请求；若失败，多为 baseUrl/Key/模型名填写有误。",
  ...
  en: {
    ...
    presetDoubaoTip: "requires an Ark endpoint ID",
    presetOllamaTip: "Local & offline, free — run `ollama pull` first",
    presetPollinationsTip: "Free, no key — reliability varies",
    ...
    llmTestTimeout: "Connection test timed out: no response within 10 seconds. Retry later or check the Ark endpoint/network.",
    ...
    llmArkEndpointTip:
      "Volcengine Ark: use the inference endpoint ID from the console for text/vision models, usually starting with ep-. Do not use the display model name.",
    llmTestTip:
      "Tip: the connection test sends a lightweight server-side request with the current text model. Failures usually mean a wrong baseUrl, key, or model name.",
